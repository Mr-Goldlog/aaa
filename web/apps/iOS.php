...
<head>
    <title>FGS - Программы</title><?=$scrollbar;?>
	<meta charset="utf-8">
...
<body <?=$fgs_copy;?>>
    ...
    <center><div style="position:relative;top:-2px;">
        <br />
        <font face="Arial" color = "white" size = 7>Программы от FGS</font>
    </div>
    <script src="/scripts/EXNuhOiGDU.js" type="text/javascript"></script>

    <div style=
    "width: 560px; height: 350px; background: rgb(0,69,248); position : relative; top : 48px;">
    </div></center><?=$snow;?>
    <br />
</body>
</html>